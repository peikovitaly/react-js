...
const SearchFullCatalog = ({type, isMobile, position, data: {preview_image, subtitle, title, price, h1, id }, data}) => {
    ...
    const favoriteAndCompareBtnType = type.includes('s') ? type.slice(0, type.length - 1) : type;
...
export default SearchFullCatalog;
